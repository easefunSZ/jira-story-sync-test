...
- **[LEAD-291](stories/LEAD-291.md)**: Investgation for name & surname impacted scenarions *(状态: 正在进行 | 故事点数: 3)*
- **[LEAD-253](stories/LEAD-253.md)**: Validation Pipeline Framework Refactoring (DAE manual Creation) *(状态: Functional Testing | 故事点数: 3)*
- **[LEAD-245](stories/LEAD-245.md)**: Validation Pipeline Framework Refactoring (SQS Message consumption) *(状态: Functional Testing | 故事点数: 8)*
- **[LEAD-209](stories/LEAD-209.md)**: Validation Pipeline Framework Refactoring (DAE batch upload) *(状态: Ready for Development | 故事点数: 5)*
- **[LEAD-170](stories/LEAD-170.md)**: Create demo showcase *(状态: 已完成 | 故事点数: 3)*
- **[LEAD-143](stories/LEAD-143.md)**: Cross Campaign - Duplicate Decision Rules *(状态: 正在进行 | 故事点数: 2)*
- **[LEAD-142](stories/LEAD-142.md)**: Duplicate Rule Precedence / Processing Order  *(状态: 正在进行 | 故事点数: 3)*
- **[LEAD-125](stories/LEAD-125.md)**: Lead Validation -Expose Validation Outcomes/Exception table ( to PFMI) *(状态: Ready for Development | 故事点数: 2)*
- **[LEAD-124](stories/LEAD-124.md)**: Lead Validation Audit Trail – Persist All Validation Outcomes per Lead *(状态: 正在进行 | 故事点数: 8)*
- **[LEAD-90](stories/LEAD-90.md)**: Lead Deduplication & Cross-Campaign Management *(状态: 正在进行 | 故事点数: 2)*
- **[LEAD-60](stories/LEAD-60.md)**: Campaign Existence & Status Validation *(状态: 正在进行 | 故事点数: 8)*
- **[LEAD-40](stories/LEAD-40.md)**: Lead Name Validation – First Name or Surname Required *(状态: 正在进行 | 故事点数: 3)*
