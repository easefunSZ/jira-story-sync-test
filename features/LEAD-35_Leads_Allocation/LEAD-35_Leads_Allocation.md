...
- **[LEAD-8](stories/LEAD-8_Opt_in_and_out_of_campaigns.md)**: Opt in and out of campaigns *(状态: 打开 | 故事点数: 3)*
- **[LEAD-7](stories/LEAD-7_Lead_Allocation_Rules.md)**: Lead Allocation : Rules  *(状态: 打开 | 故事点数: 5)*
- **[LEAD-6](stories/LEAD-6_Enhance_ingestion_of_lead_data.md)**: Enhance ingestion of  lead data *(状态: Ready for Deployment | 故事点数: 3)*
