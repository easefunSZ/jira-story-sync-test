# Story - LEAD-111: Develop Rule Configuration and Amendment Functionality
...
Implement backend and frontend logic to allow users to create, amend, and manage allocation rules, including support for all rule groupings (advisors, allocation groups, postal codes, income bands).
