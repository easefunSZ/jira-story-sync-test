# Story - LEAD-114: Implement Role-Based Access Control for Rule Management UI
...
Develop and enforce access controls so only users with specified roles can access and modify allocation rules through the UI.
