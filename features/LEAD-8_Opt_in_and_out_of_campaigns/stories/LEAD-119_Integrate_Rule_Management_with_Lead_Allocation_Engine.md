# Story - LEAD-119: Integrate Rule Management with Lead Allocation Engine
...
Ensure that changes made via the rule management UI are reflected in the lead allocation logic in real time or batch, as required. Address edge cases such as adviser availability status.
