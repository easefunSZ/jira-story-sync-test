# Story - LEAD-118: As a manager (PF)  I want to filter the leads information of my team by a period, count and %, so that I can track the team's contribution
...
💬 **[View Comments & Discussions (查看评审与讨论历史)](LEAD-118_As_a_manager_PF_I_want_to_filter_the_leads_information_of_my_team_by_a_period_count_and_so_that_I_can_track_the_teams_contribution_comments.md)**
