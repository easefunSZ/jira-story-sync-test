...
- **[LEAD-193](stories/LEAD-193_Expose_Exception_data.md)**: Expose Exception data *(状态: 待办 | 故事点数: 1)*
- **[LEAD-189](stories/LEAD-189_Expose_Lead_closure_reasons.md)**: Expose Lead closure reasons *(状态: 待办 | 故事点数: 1)*
- **[LEAD-188](stories/LEAD-188_Expose_Lead_priority_and_volumes.md)**: Expose Lead priority and volumes *(状态: 待办 | 故事点数: 2)*
- **[LEAD-116](stories/LEAD-116_Expose_SLA_Indicators.md)**: Expose SLA Indicators *(状态: 待办 | 故事点数: 3)*
- **[LEAD-112](stories/LEAD-112_Expose_Lead_state_and_Lead_state_change_timestamps.md)**: Expose  Lead state and Lead state change timestamps *(状态: 待办 | 故事点数: 3)*
- **[LEAD-109](stories/LEAD-109_Expose_Lead_allocation_data.md)**: Expose Lead allocation data *(状态: 待办 | 故事点数: 3)*
- **[LEAD-107](stories/LEAD-107_Enhance_Consumable_Data_Feed_Access.md)**: Enhance Consumable Data Feed Access *(状态: 待办 | 故事点数: 3)*
- **[LEAD-105](stories/LEAD-105_Expose_campaign_metadata_and_metadata_success.md)**: Expose campaign metadata and metadata success  *(状态: Analysis | 故事点数: 3)*
