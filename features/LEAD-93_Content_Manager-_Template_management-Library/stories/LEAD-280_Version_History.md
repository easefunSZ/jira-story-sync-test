# Story - LEAD-280: Version History
...
Each version record captures: version number, published by (user name), published date/time, and an optional change summary entered by the Content Manager at publish time
