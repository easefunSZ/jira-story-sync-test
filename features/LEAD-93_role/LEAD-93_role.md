...
- **[LEAD-307](stories/LEAD-307.md)**: Archive a category/subcategory *(状态: 待办 | 故事点数: 5)*
- **[LEAD-306](stories/LEAD-306.md)**: Create a new template *(状态: 待办 | 故事点数: 3)*
- **[LEAD-303](stories/LEAD-303.md)**: Upload a template file *(状态: 待办 | 故事点数: 5)*
- **[LEAD-302](stories/LEAD-302.md)**: Safe a draft view template *(状态: 待办 | 故事点数: 1)*
- **[LEAD-301](stories/LEAD-301.md)**: Assign a  Category *(状态: 待办 | 故事点数: 1)*
- **[LEAD-300](stories/LEAD-300.md)**: Assign Tags *(状态: 待办 | 故事点数: 1)*
- **[LEAD-299](stories/LEAD-299.md)**: Edit Tags and Metadata *(状态: 待办 | 故事点数: 2)*
- **[LEAD-298](stories/LEAD-298.md)**: Edit a Template *(状态: 待办 | 故事点数: 3)*
- **[LEAD-297](stories/LEAD-297.md)**: Duplicate a template *(状态: 待办 | 故事点数: 2)*
- **[LEAD-296](stories/LEAD-296.md)**: Delete & Archive a template *(状态: 待办 | 故事点数: 5)*
- **[LEAD-295](stories/LEAD-295.md)**: Access to template actions *(状态: 待办 | 故事点数: 1)*
- **[LEAD-294](stories/LEAD-294.md)**: Edit Category *(状态: 待办 | 故事点数: 3)*
- **[LEAD-293](stories/LEAD-293.md)**: Create a category *(状态: 待办 | 故事点数: 3)*
- **[LEAD-280](stories/LEAD-280.md)**: Template versioning *(状态: 待办 | 故事点数: 8)*
- **[LEAD-279](stories/LEAD-279.md)**: Manage Draft & Publish Workflow  *(状态: 待办 | 故事点数: 8)*
- **[LEAD-278](stories/LEAD-278.md)**: Manage Template Content  *(状态: 待办 | 故事点数: 3)*
- **[LEAD-277](stories/LEAD-277.md)**: Field level validation rules *(状态: 待办 | 故事点数: 3)*
- **[LEAD-276](stories/LEAD-276.md)**: Reassign Template to a Different Category  *(状态: 待办 | 故事点数: 3)*
