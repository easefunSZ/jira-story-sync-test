...
- **[LEAD-46](stories/LEAD-46_Test_duplicate_lead_prevention_and_hot_lead_indicator_functionality.md)**: Test duplicate lead prevention and hot lead indicator functionality *(状态: 待办)*
- **[LEAD-45](stories/LEAD-45_Map_Everlytic_lead_data_to_UI_components.md)**: Map Everlytic lead data to UI components *(状态: 待办)*
- **[LEAD-44](stories/LEAD-44_Prioritise_leads_with_hot_lead_indicator_at_the_top_of_leads_list.md)**: Prioritise leads with hot lead indicator at the top of leads list *(状态: 待办)*
- **[LEAD-43](stories/LEAD-43_Implement_hot_lead_indicatornotification_on_existing_leads.md)**: Implement hot lead indicator/notification on existing leads *(状态: 待办)*
- **[LEAD-42](stories/LEAD-42_Update_API_to_prevent_creation_of_duplicate_leads_from_Everlytic.md)**: Update API to prevent creation of duplicate leads from Everlytic *(状态: 待办)*
- **[LEAD-41](stories/LEAD-41_Design_mechanism_to_identify_duplicate_active_leads_in_DAE.md)**: Design mechanism to identify duplicate active leads in DAE *(状态: 待办)*
