...
- **[LEAD-266](stories/LEAD-266_Demo_Requirements.md)**: Demo Requirements *(状态: 待办 | 故事点数: 3)*
- **[LEAD-208](stories/LEAD-208_Master_rule_matrix.md)**: Master rule matrix *(状态: 正在进行 | 故事点数: 3)*
- **[LEAD-176](stories/LEAD-176_Controlled_Display_of_Campaign_Information_in_Leads_Pool.md)**: Controlled Display of Campaign Information in Leads Pool *(状态: Analysis | 故事点数: 3)*
- **[LEAD-175](stories/LEAD-175_Maturity_Lead_Visibility_in_My_Leads_after_acceptance.md)**: Maturity Lead Visibility in My Leads ( after acceptance) *(状态: Analysis | 故事点数: 3)*
- **[LEAD-66](stories/LEAD-66_Conditional_Display_of_Maturity_Features.md)**: Conditional Display of Maturity Features *(状态: Analysis | 故事点数: 3)*
- **[LEAD-32](stories/LEAD-32_Audit_Reporting_of_Enrichment_Outcomes.md)**: Audit & Reporting of Enrichment Outcomes *(状态: Analysis | 故事点数: 3)*
- **[LEAD-29](stories/LEAD-29_Enrich_Maturity_Leads_Prior_to_Allocation.md)**: Enrich Maturity Leads Prior to Allocation *(状态: Analysis | 故事点数: 3)*
