...
VALUES ('CONTENT_TYPE', 'CONTENT_TYPE_EMAIL', 'Email', 'Standard email communication', 10, 0, @migration_user, @migration_user),
       ...
       ('PROPOSITION_SOURCE', 'PROPOSITION_SOURCE_OM_BANK', 'OM Bank', 'OM Bank offering related', 10, 0, @migration_user, @migration_user),
       ('PROPOSITION_SOURCE', 'PROPOSITION_SOURCE_REWARDS', 'Rewards', 'Rewards programme related', 20, 0, @migration_user, @migration_user)
