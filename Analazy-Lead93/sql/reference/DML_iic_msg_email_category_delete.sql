...
-- 1. Insert one iic_msg_email_category_change_history row per soft-deleted
--    Category/Subcategory node with change_type=DELETE.
-- 2. For reassign-and-delete, insert one iic_msg_email_template_change_history
--    row per affected Template with change_type=CATEGORY_REASSIGNMENT.
-- 3. Insert one iic_msg_email_category_delete_audit operation row.
-- Category history, Template history, and delete audit share operation_id.
