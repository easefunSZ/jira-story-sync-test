...
-- Associated Category/Subcategory node lifecycle details.
SELECT h.category_id,
       ...
       h.changed_by,
       h.changed_date
FROM iic_msg_email_category_change_history h
WHERE h.operation_id = :operation_id AND h.change_type = 'DELETE'
