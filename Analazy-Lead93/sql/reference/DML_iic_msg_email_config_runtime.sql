...
VALUES (:module_code, :scenario_code, :new_email_code, :email_name, :description, 0, :tenant_id, :operator, CURRENT_TIMESTAMP, :operator, CURRENT_TIMESTAMP, 0, :channel, :channel_name, 0, NULL, :dae_country_code, :is_custom_branding, 0, :category_id, :source_email_code);
