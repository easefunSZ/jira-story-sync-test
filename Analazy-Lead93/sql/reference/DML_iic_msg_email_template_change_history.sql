...
-- this stable business-field boundary from iic_msg_email_config: emailCode,
-- templateName, description, emailStatus, status, channel, channelName,
-- customBranding, isCampaign, categoryId and copyFromEmailCode. It also contains
-- Category/Subcategory/Tag display snapshots. Module/scenario, send statistics,
-- tenant/country and maintenance fields are intentionally excluded.
