CREATE TABLE IF NOT EXISTS iic_msg_template_migration_snapshot (
  ...
  record_type varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'CONFIG or VERSION',
  ...
  UNIQUE KEY uk_template_migration_snapshot (source_batch_id, record_type, record_id),
  KEY idx_template_migration_snapshot_email (source_batch_id, email_code)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='LEAD-93 migration rollback snapshot';
